...
CMD bin/maxwell --user=$MYSQL_USER --password=$MYSQL_PASSWORD --host=$MYSQL_HOST --port=$MYSQL_PORT --producer=$PRODUCER --kafka.bootstrap.servers=$KAFKA_HOST:$KAFKA_PORT --log_level=$LOG_LEVEL
